...
namespace VectorVertex
{
    ...
    VKOffscreen::~VKOffscreen()
    {
        clean();
    }


    void VKOffscreen::StartRenderpass(VkCommandBuffer commandBuffer)
    {
    ...
    void VKOffscreen::EndRendrepass(VkCommandBuffer commandBuffer)
    {
    ...
    void VKOffscreen::Resize(VkExtent2D new_extent)
    {
    ...
    void VKOffscreen::SetAccordingtoAspectRatio(VkExtent2D &old_extent, VkExtent2D new_extent)
    {
    ...
    void VKOffscreen::create_resources()
    {
