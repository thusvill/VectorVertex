...
namespace VectorVertex
{
  ...
  VKSwapChain::VKSwapChain(VKDevice &deviceRef, VkExtent2D windowExtent, std::shared_ptr<VKSwapChain> previous) : device{deviceRef}, windowExtent{windowExtent}, oldSwapChain{previous}
  {
    init();
  ...
  VkResult VKSwapChain::submitCommandBuffers(
  ...
  VkResult VKSwapChain::submitCommandBuffersToAFence(const VkCommandBuffer *buffers, uint32_t *imageIndex, VkFence fence)
  {
